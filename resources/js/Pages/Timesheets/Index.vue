                  ...
                  <tr v-for="timesheet in timesheets.data" :key="timesheet.id" class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                      <div class="flex justify-center">
                        <svg v-if="timesheet.description && timesheet.description.includes('Auto-generated from attendance')" 
                        ...
                        <svg v-else-if="timesheet.description && timesheet.description.includes('Synced with Attendance')" 
