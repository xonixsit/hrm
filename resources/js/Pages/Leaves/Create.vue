            ...
            <form @submit.prevent="handleSubmit" class="space-y-8">
              ...
              <div v-show="currentStep === 1" class="space-y-6">
                      ...
                      <div class="flex items-start">
                        ...
                        <div class="ml-3 flex-1">
                          ...
                          <div class="flex items-center mt-2 text-xs text-gray-500">
                            ...
                            <span>{{ type.balance || 'N/A' }} days available</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="space-y-4">
                  ...
                  <div v-if="exceedsBalance" class="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    <div class="flex">
                      ...
                      <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                          <p>
                            You have requested {{ requestedDuration }} days, but you only have {{ selectedLeaveType.balance }} days available for {{ selectedLeaveType.name }}.
                          </p>
                        </div>
                      </div>
                    </div>
...
const exceedsBalance = computed(() => {
  if (selectedLeaveType.value && selectedLeaveType.value.balance !== null && selectedLeaveType.value.balance !== undefined) {
    return requestedDuration.value > selectedLeaveType.value.balance;
  }
  return false;
});
