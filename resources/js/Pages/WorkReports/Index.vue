<template>
  <AuthenticatedLayout>
    <PageLayout title="Performance Analytics" subtitle="Track and analyze employee performance metrics"
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div class="flex flex-wrap items-center bg-gray-100 rounded-lg p-1 gap-1">
                    <button v-for="period in intelligentPeriods" :key="period.key"
              ...
              <div v-if="employees.length > 0" class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <BaseSelect v-model="localFilters.user_id" :options="employeeOptions" placeholder="All employees"
                    class="w-full" @update:modelValue="applyFilters" />
                </div>
                ...
                <div>
                  ...
                  <div class="flex items-center bg-gray-100 rounded-lg p-1 w-full">
                    <button @click="performanceViewMode = 'individual'"
                    ...
                    <button @click="performanceViewMode = 'comparison'"
            ...
            <div class="space-y-4">
              <div v-for="employee in comparisonData" :key="employee.id" class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div class="w-32 bg-gray-200 rounded-full h-2">
                    <div class="bg-green-500 h-2 rounded-full" :style="{ width: `${employee.success_rate}%` }"></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div v-if="performanceStats && (performanceViewMode === 'individual' || !performanceViewMode)"
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div v-if="performanceStats && performanceStats.total_calls > 0" class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center">
                <span class="text-sm font-semibold text-gray-900 mr-2">{{ performanceStats.calls_not_received || 0
                  }}</span>
                <div class="w-24 bg-gray-200 rounded-full h-2">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center">
                <span class="text-sm font-semibold text-gray-900 mr-2">{{ performanceStats.disconnected_calls || 0
                  }}</span>
                <div class="w-24 bg-gray-200 rounded-full h-2">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 mt-8">
        ...
        <div v-if="workReports.data.length > 0">
          ...
          <div v-if="!showDetailedView" class="divide-y divide-gray-200">
            <div v-for="report in workReports.data.slice(0, 5)" :key="report.id"
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div class="flex items-center justify-end">
                      <div class="relative" :ref="el => setDropdownRef(el, row.id)">
                        <button @click="toggleDropdown(row.id)"
                        ...
                        <div v-if="activeDropdown === row.id"
                          class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-10">
                          <Link :href="`/work-reports/${row.id}`"
                          ...
                          <Link :href="`/work-reports/${row.id}/edit`"
                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150">
                          <svg class="w-4 h-4 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div v-else class="text-center py-12">
          ...
          <div v-if="emptyState.actions.length > 0" class="mt-6">
            <button
