        ...
        <div class="p-6 text-gray-900">
          <form @submit.prevent="handleSubmit" class="space-y-8">
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select v-model="form.assessment_cycle_id" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                  ...
                  <select v-model="form.assessment_type" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
              ...
              <div v-if="selectedCycle" class="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div class="flex items-center justify-between text-sm">
                  ...
                  <span class="text-blue-700">{{ formatDate(selectedCycle.start_date) }} - {{ formatDate(selectedCycle.end_date) }}</span>
                </div>
              </div>
            </div>
              ...
              <div v-if="displayedEmployees.length > 0" class="max-h-60 overflow-y-auto border border-gray-200 rounded-lg">
                ...
                >
                  <div class="flex items-center space-x-3 flex-1">
                    <div class="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 font-medium text-xs flex-shrink-0">
                  ...
                  <div class="flex-shrink-0">
                    <div 
                      ...
                      :class="form.employee_ids.includes(employee.id) 
            ...
            <div class="space-y-4">
              ...
              <!-- Competency List -->
              <div v-if="selectedCategory && competenciesByCategory.length > 0" class="max-h-60 overflow-y-auto border border-gray-200 rounded-lg">
                <div
                ...
                >
                  ...
                  <div class="flex-shrink-0">
                    <div 
                      class="w-4 h-4 rounded border-2 flex items-center justify-center"
                      :class="form.competency_ids.includes(competency.id) 
                        ? 'bg-blue-600 border-blue-600' 
                        : 'border-gray-300'"
                    >
                      <CheckIcon 
            ...
            <div class="flex items-center justify-between pt-6 border-t border-gray-200">
              ...
              <button
                ...
                :disabled="!canSubmit"
                @click="handleSubmit"
                class="inline-flex items-center px-6 py-3 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
