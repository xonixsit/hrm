...
<template>
    <AuthenticatedLayout>
        <template #header>Edit Competency</template>
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-base font-semibold leading-6 text-gray-900">Edit Competency</h1>
                    <p class="mt-2 text-sm text-gray-700">Update the competency details for your organization.</p>
                </div>
            </div>
                ...
                <form @submit.prevent="submit">
                    <div class="space-y-12">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">Update the core details of this competency.</p>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">Update specific indicators that will be used to measure this competency.</p>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">Update what each rating level means for this competency.</p>
