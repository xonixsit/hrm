        ...
        <div class="bg-white rounded-lg shadow-sm">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8">
            ...
            <div class="lg:col-span-2 space-y-8">
              ...
              <!-- AI Integration -->
              <div>
                <h3 class="text-lg font-semibold text-gray-900 mb-6">AI Integration</h3>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">Groq API Key <span class="text-xs text-gray-400">(TaxGPT)</span></label>
                  <div class="relative">
                    <input
                      v-model="form.groq_api_key"
                      :type="showGroqKey ? 'text' : 'password'"
                      placeholder="gsk_..."
                      class="w-full px-3 py-2 pr-20 border border-gray-300 rounded-md focus:ring-2 focus:ring-teal-500 focus:border-teal-500 font-mono text-sm"
                    />
                    <button type="button" @click="showGroqKey = !showGroqKey"
                      class="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-500 hover:text-gray-700">
                      {{ showGroqKey ? 'Hide' : 'Show' }}
                    </button>
                  </div>
                  <p class="mt-1 text-xs text-gray-400">Get your key at <a href="https://console.groq.com" target="_blank" class="text-teal-600 hover:underline">console.groq.com</a>. Overrides the .env value.</p>
                </div>
              </div>
