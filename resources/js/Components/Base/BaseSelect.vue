      ...
      >
        ...
        >
          ...
          <div class="max-h-60 overflow-auto py-1" role="listbox">
            ...
            >
              <!-- Custom Option Slot or Default Content -->
              <slot 
                name="option" 
                :option="option" 
                :index="index" 
...
const getOptionClasses = (option, index) => [
  'relative cursor-default select-none text-left w-full',
  'hover:bg-neutral-100 focus:bg-neutral-100 focus:outline-none',
  'transition-colors duration-150',
  // Content-aware padding - let the content determine the height
  'py-1.5 px-3', // Reduced vertical padding for better content flow
  {
