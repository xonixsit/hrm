    ...
    <div class="quick-actions">
      ...
      <div class="actions-grid">
        <button v-for="action in quickActions" :key="action.id" 
          @click="handleQuickAction(action)" class="action-button">
...
.action-button {
  @apply flex flex-col items-center space-y-2 p-4 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors cursor-pointer;
}
