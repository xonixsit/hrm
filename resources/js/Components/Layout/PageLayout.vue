<template>
  <div :class="layoutClasses">
    <!-- Page Header -->
    <PageHeader v-if="showHeader" :title="title" :subtitle="subtitle" :breadcrumbs="breadcrumbs" :actions="actions"
      :tabs="tabs" :sticky="stickyHeader" @tab-change="handleTabChange" @action="handleAction">
        ...
        <div v-else-if="error" class="error-container">
          <div class="error-content">
            ...
            <div v-if="error.actions" class="error-actions">
              <button v-for="action in error.actions" :key="action.label" @click="action.handler"
